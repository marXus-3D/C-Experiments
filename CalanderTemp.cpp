    ...
    switch(sMenu)
    {
        ...
        case 2:
            ...
            if (lMenu==1)
            {
                ...
                if (eY%4==0)// checking for leap year
                eD++;
        ...
        if (aMenu<0||aMenu>3)
            ...
            if (aMenu==1)
            {
                ...
                if (eY % 400 == 0) // checking for leap year
                    leap = 6;
                else if (eY % 4 == 0)
                    leap = 6;
                else leap = 5;
        ...
        if (bMenu<0||bMenu>3)
            ...
            if(bMenu==1)
            {
                do
                {
                    do
                    {
                        ...
                        if (eD<0||eD>30||eM<0||eM>13||eY<0)
                            cerr <<endl<< "Error Invalid Input"<<endl;
                    }while(eD<0||eD>30||eM<0||eM>13||eY<0);// loop for validating the user input
                ...
                }while(gY<eY||(gY==eY&gM<eM)||(gY==eY&gM==eM&gD<eD));// loop for validating the second date is bigger than the first
                ...
                if (ans=='Y'||ans=='y')
                    cout <<endl<< "The difference between the dates in days is: " << int(tD + tM*30 + tY*365.25)+1 << " Days";
                else
                    cout <<endl<< "The difference between the dates in days is: " << int(tD + tM*30 + tY*365.25) << " Days";
            ...
            }else
            {
                ...
                }while(gY<eY|(gY==eY&gM<eM)||(gY==eY&gM==eM&gD<eD));// loop for validating the user input
                ...
                do
                {
                    ...
                    if (ans=='y'||ans=='n'||ans=='Y'||ans=='N')
                        error = false;
                }while(error);// loop for validating the user input
        ...
        case 5:
            do
            {
                ...
                cout << "Enter the year: ";
                cin >> eY;
            }while(eY<1);// loop for validating the user input

            amAlem = bcYear + eY; // calculating the amete alem
            zemenR = amAlem%4; // dividing the amete alem and taking the reaminder

            cout << zemen[zemenR]; // displaying the zemen from the array
            break;
        case 6:
            do
            {
        ...
        if (cMenu<1||cMenu>3)
            ...
            }while(cMenu<1||cMenu>3);// loop for validating the user input for the menu
        ...
        case 8:
            ...
            cout << endl;
            int ameteRab;
            ameteRab = (yearE+bcYear)+(yearE+bcYear)/4;

            firstDME = ameteRab%7; // calculate the first day of the year
            if (firstDME == 6) // since the loop count 0 as sunday if the remainder is 6 make it 0
                firstDME = 0;
            else firstDME++; // add one since sunday is zero

            system("cls"); // clear the above text
            cout << yearE <<endl;

            for (int k=0; k<13; ++k)
            {
                cout <<left<< setw(10) <<  monthE[k] << '\t' << yearE << endl; // displays the month and year
                numDaysE = daysE[k]; //giving the total number of days in that month
                ...
                while (iE>0)
                {
                    cout << "   "; // making empty spaces untill the first day
                    --iE;
                }

                while (dayE <= numDaysE) // loop for displaying the days
                {
                    cout << setw(2) << dayE << " "; // displaying the day then leaving space for the next day
                    if(firstDME == 6) // if the day is saturday making the next day sunday for it to not overflow
                    {
                        cout << endl;
                        firstDME = 0;
                    }else
                    {
                        ++firstDME; // otherwise adding one day for the next month
                    }
        ...
        case 9:
            ...
            cin >> year;
                ...
                if (year % 400 == 0)
                    days[1]=29; // making february 29 if it is leap year
                else if (year % 4 == 0)
                    days[1]=29;
            ...
            firstDM = (year + x1 - x2 +x3)%7; // calculating the first day of the month

            cout << year << endl << endl;

            for (int k=0; k<12; ++k) // loop for all of the months
            {
                cout <<left<< setw(10) <<  month[k] << '\t' << year << endl; // displaying the year and month
                numDays = days[k]; //giving the total number of days in that month

                cout <<right<< " S  M  T  W  T  F  S" << endl; // listing the days of the week
                cout <<"--------------------" << endl;

                int day = 1; // initializing the first day as 1
                int i = firstDM;
                while (i>0) // loop for making empty spaces untill the first day
                {
                    cout << "   ";
                    --i;
                }

                while (day <= numDays) // loop for listing days
                {
                    cout << setw(2) << day << " "; // listing the day and leaving space for the next
                    if(firstDM == 6)// if the day is saturday making the next day sunday for it to not overflow
                    {
                        cout << endl;
                    firstDM = 0;
                    }else
                    {
                        ++firstDM;// otherwise adding one day for the next month
                    }

                    day++; //adding 1 to the current day
                }
